...
ax.set_title("Complete clustering $K = 3$ Scatter plot")
...
# plot_dendrogram(complete, labels=complete.labels_)

linked = linkage(X, "complete")
label_list = complete.labels_
dendrogram(
    linked,
    orientation="top",
    labels=label_list,
...
plt.title("Complete Clustering $K=3$ Dendrogram")
